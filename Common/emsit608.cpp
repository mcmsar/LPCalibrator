...
CEMSSit608::CEMSSit608() : m_iSatCount(0)
{
	SetSitNumber( 608 );
}
...
EMS_RESULT CEMSSit608::ParseSitHeader( CEMSSitTokenizer *lpTokenizer, BOOL bPeek )
{
...
EMS_RESULT CEMSSit608::ParseSitMessage( CEMSSitTokenizer *lpTokenizer )
{
	...
	// Read GMS Data. This is just a read of the line right now. The data 
	// is not used by the system. So, real parsing implementation is not 
