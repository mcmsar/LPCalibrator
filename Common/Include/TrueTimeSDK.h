...
TT_API TT_STATUS TT_SetPhaseCompensation(
	HANDLE		hDevice,			// @parm A handle to the TrueTime device, returned by <f TT_OpenDevice>.
//	LONG		lOffset				// @parm Specifies the desired compensation from -1000 to +1000 microseconds.
	SHORT		lOffset				// @parm Specifies the desired compensation from -1000 to +1000 microseconds.
	);
...
TT_API TT_STATUS TT_GetPhaseCompensation(
	HANDLE		hDevice,			// @parm A handle to the TrueTime device, returned by <f TT_OpenDevice>.
//	LONG*		plOffset			// @parm Address of <t LONG> to receive the current compensation from -1000 to +1000 microseconds.
	SHORT*		plOffset			// @parm Address of <t LONG> to receive the current compensation from -1000 to +1000 microseconds.
	);
